...
public class Base64Utils {
    public static void main(String[] args) {
        ...
        GenerateImage(strImg, "/data/wangyc.jpg");
        
        // 测试从图片文件转换为Base64编码
        System.out.println(GetImageStr("/data/wangyc.jpg"));
    }
     ...
     * @return
     */
    public static byte[] GetImageStr(String imgFilePath) {
        byte[] data = null;
        ...
        // 对字节数组Base64编码       
        return Base64.encodeBase64(data);// 返回Base64编码过的字节数组字符串, sun做法：//BASE64Encoder encoder = new BASE64Encoder();
    }
    ...
    public static boolean GenerateImage(String imgStr, String imgFilePath) {// 对字节数组字符串进行Base64解码并生成图片
        ...
        try {
            // Base64解码，sun做法：//byte[] bytes = decoder.decodeBuffer(imgStr);            
            ...
            ImageUtils.cutJPG(bais, out);//文安给的图片是拼接的图片，只需要拼接的第一幅图片，所以需要截取
